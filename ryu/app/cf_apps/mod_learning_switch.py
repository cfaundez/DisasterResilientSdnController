...
DEFAULT_IDLE_TIMEOUT = 600 # 60 orig
DEFAULT_HARD_TIMEOUT = 3000 # 300 orig

# CFAUNDEZ ADD: Work on specified table
DEFAULT_ROUTING_TABLE_ID = 20
...
class L2LearningSwitch(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.exemption = []
        self.switch_flows = {}
        self.table_id = DEFAULT_ROUTING_TABLE_ID  # CFAUNDEZ ADD
        self.name = 'mod_learning_switch'  # CFAUNDEZ ADD
    ...
    def add_flow(self, datapath, priority=ofproto_v1_3.OFP_DEFAULT_PRIORITY, match=None,
        ...
        mod = ofp_parser.OFPFlowMod(datapath=datapath, priority=priority,
                                    ...
                                    table_id=self.table_id)  # CFAUNDEZ EDIT: add table id
